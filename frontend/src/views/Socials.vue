    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-2xl mx-auto">
        ...
        <div class="card p-8 text-center opacity-50">
          <div class="w-16 h-16 mx-auto mb-4 bg-indigo-500 rounded-full flex items-center justify-center">
            <svg class="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          <p class="text-gray-600 dark:text-gray-300 mb-4">
            Coming soon! Discord server for voice chats and gaming
          </p>
      ...
      <div class="mt-16 text-center">
        ...
        <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-6 max-w-md mx-auto">
          ...
          <a 
            href="mailto:contact@furban.community" 
            class="text-primary-600 dark:text-primary-400 font-medium hover:underline"
          >
            contact@furban.community
          </a>
        </div>
      </div>
    </div>
