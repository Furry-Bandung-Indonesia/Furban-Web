                    ...
                    <div v-for="(group, groupName) in groupedChannels" :key="groupName">
                      ...
                      <div class="flex flex-col gap-2">
                        <label v-for="ch in group" :key="ch.code"
                          ...
                          <img v-if="ch.image_url" :src="ch.image_url.replace(/https:\/\/(?:dash|dashboard|gateway|www\.)?wijayapay\.com/g, 'https://app.wijayapay.com')" :alt="ch.name" class="w-12 h-8 object-contain rounded bg-white p-1" />
