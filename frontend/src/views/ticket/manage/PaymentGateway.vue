                ...
                <div class="flex items-start justify-between gap-3 mb-3">
                  <div class="flex items-center gap-3">
                    <div class="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center overflow-hidden shrink-0">
                      <img v-if="channel.image_url" :src="channel.image_url.replace(/https:\/\/(?:dash|dashboard|gateway|www\.)?wijayapay\.com/g, 'https://app.wijayapay.com')" :alt="channel.name" class="w-8 h-8 object-contain" @error="(e) => e.target.style.display='none'" />
